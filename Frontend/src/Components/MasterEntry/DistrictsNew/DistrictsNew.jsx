...
const DistrictsNew = () => {
  ...
  function initialForm() {
    return {
      ...
      // Division_name_Hindi: "",
      // Division_name_English: "",
      flag: "select Status", // default Active
      DisplayOrder: 1,
      ip_address: "",
    };
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        await axios.post("http://localhost:3080/api/districtnew/add-districtnew", payload);
        setAlertMessage("Added successfully");
      }
  ...
  const AlertBox = ({ message, onClose }) => (
    ...
    >
      <div
        className="bg-success-subtle fs-4 fw-bold"
        style={{
          backgroundColor: "#fff",
          padding: "20px 30px",
          borderRadius: "8px",
        ...
        <div className="modal show d-block" tabIndex="-1" style={{ background: "#00000080" }}>
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              <form onSubmit={handleSubmit}>
                <div className="modal-header">
                  <h5 className="modal-title">{isEditing ? "Edit" : "Add"} District</h5>
                ...
                <div className="modal-body row g-3">
                  ...
                  <div className="col-md-6">
                    <label className="form-label">District Name (English)</label>
                    <input
                      type="text"
                      name="District_Name_En"
                      value={formData.District_Name_En}
                      onChange={handleChange}
                      className="form-control"
                      required
                    />
